      ...
      <div className="text-center space-y-4">
        ...
        className="flex flex-col md:flex-row justify-center items-center mb-4 md:px-24">
          <input
            ...
            type="text"
            placeholder="Search Phon by Name"
            className="bg-white border border-gray-300 rounded  shadow-md w-2/3 h-14 px-4 mb-4 focus:outline-none focus:shadow-outline md:mr-2 md:mb-0"
          />
          <button type="submit"  href="#_" className="relative inline-block text-lg group cursor-pointer ">
